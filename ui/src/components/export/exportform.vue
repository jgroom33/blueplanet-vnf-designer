<template>
  <div id="exportform">
    <div class="header">
      ...
      <div class="button" title="download archive" v-on:click="downloadArchive">
        <i class="fas fa-file-archive" />&nbsp;Archive
      </div>
      <div class="button" title="download file" v-on:click="download">
      ...
      <div class="format">
        ...
        <select v-model="view.export">
          <option v-for="format in formats" :key="format" v-bind:value="format">
            {{ format }}
          </option>
        </select>
      </div>
