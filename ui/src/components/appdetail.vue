<template>
  <div id="appdetail">
    ...
    ></exportform>
    <importform v-if="view.detail === 'Import'" v-bind:model="model" v-bind:view="view"></importform>
    <tenant v-if="view.detail === 'Tenant'" v-bind:model="model" v-bind:view="view"></tenant>
  </div>
</template>
<script>
export default {
