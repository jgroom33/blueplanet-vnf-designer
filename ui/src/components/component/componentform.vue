  ...
  <div id="componentform">
    ...
    <div class="line">
      ...
      <select
        ...
        v-bind:class="{ valid: zones.includes(component.placement) }"
        required
      >
      ...
      <select
        ...
        v-bind:class="{ valid: flavors.includes(component.flavor) }"
        v-if="component.placement != 'OTHER' && component.placement != 'ROUTER'"
        required
      >
        <option disabled value="">Please select one</option>
      ...
      <select
        ...
        v-bind:class="{ valid: images.includes(component.image) }"
        v-if="component.placement != 'OTHER' && component.placement != 'ROUTER'"
        required
      >
        <option disabled value="">Please select one</option>
    ...
    >
      <input
        v-bind:id="'volumes_' + index + '_name'"
        v-bind:name="'volumes_' + index + '_name'"
        v-model="volume.name"
        required
      />
      <input
        v-bind:id="'volumes_' + index + '_size'"
        v-bind:name="'volumes_' + index + '_size'"
        v-model.number="volume.size"
        type="number"
        required
      />
      <select
        v-bind:id="'volumes_' + index + '_type'"
        v-bind:name="'volumes_' + index + '_type'"
        v-model="volume.type"
        v-bind:class="{ valid: storagetypes.includes(volume.type) }"
        required
      >
        <option disabled value="">Please select one</option>
      ...
      <input
        v-bind:id="'volumes_' + index + '_attributes'"
        v-bind:name="'volumes_' + index + '_attributes'"
        v-model="volume.attributes"
      />
      <label v-on:click="delVolume(volume)"
    ...
    >
      <select
        v-bind:id="'interfaces_' + index + '_network'"
        v-bind:name="'interfaces_' + index + '_network'"
      ...
      <input
        class="col3"
        v-bind:id="'interfaces_' + index + '_attributes'"
        v-bind:name="'interfaces_' + index + '_attributes'"
        v-model="componentInterface.attributes"
      />
      <label v-on:click="delInterface(componentInterface)"
        ><i class="fas fa-minus-circle"
      /></label>
    </div>
    ...
    >
      <input
        v-bind:id="'services_' + index + '_name'"
        v-bind:name="'services_' + index + '_name'"
        v-model="service.name"
        required
      />
      <select
        v-bind:id="'services_' + index + '_network'"
        v-bind:name="'services_' + index + '_network'"
        v-model="service.network"
        v-bind:class="{ valid: service.network !== '' }"
      >
        <option disabled value="">Please select one</option>
        <option
          v-for="componentInterface in component.interfaces"
          v-bind:value="componentInterface.network"
        >
          {{ componentInterface.network }}
        </option>
      </select>
      <select
        v-bind:id="'services_' + index + '_protocol'"
        v-bind:name="'services_' + index + '_protocol'"
        v-model="service.protocol"
        v-bind:class="{ valid: protocols.includes(service.protocol) }"
        required
      >
        <option disabled value="">Please select one</option>
      ...
      <input
        v-bind:id="'services_' + index + '_range'"
        v-bind:name="'services_' + index + '_range'"
        v-model="service.range"
        required
      />
      <label v-on:click="delService(service)"
        ><i class="fas fa-minus-circle"
      /></label>
    </div>
    ...
    <div class="line" v-if="component.placement != 'ROUTER'">
      ...
      <label class="top">Network</label>
      <label v-on:click="addDependency()"
    ...
    >
      <select
        v-bind:id="'dependencies_' + index + '_component'"
        v-bind:name="'dependencies_' + index + '_component'"
        v-model="dependency.component"
        v-bind:class="{ valid: components.includes(dependency.component) }"
        required
      >
        <option disabled value="">Please select one</option>
      ...
      <select
        v-bind:id="'dependencies_' + index + '_service'"
        v-bind:name="'dependencies_' + index + '_service'"
      ...
      >
        ...
        <option
          ...
          v-bind:value="service.service"
        >
          {{ service.service }}
        </option>
      </select>
      <select
        v-bind:id="'dependencies_' + index + '_network'"
        v-bind:name="'dependencies_' + index + '_network'"
        v-model="dependency.network"
        v-bind:class="{ valid: interfaces.includes(dependency.network) }"
        required
      >
        <option disabled value="">Please select one</option>
        <option
      ...
      <label v-on:click="delDependency(dependency)"
        ><i class="fas fa-minus-circle"
      /></label>
    </div>
